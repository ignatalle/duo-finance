    ...
    <div className="rounded-2xl border border-zinc-700 bg-zinc-900/50 overflow-hidden">
      ...
      <div className="divide-y divide-zinc-800">
        {items.map(({ tarjeta, cuota }, i) => {
          ...
          return (
            <div key={i} className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 px-5 py-4 hover:bg-zinc-800/30 transition-colors">
              ...
              <div className="w-full text-left sm:w-auto sm:text-right shrink-0 border-t border-zinc-800/50 pt-3 sm:border-0 sm:pt-0">
