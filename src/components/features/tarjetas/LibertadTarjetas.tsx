...
export function LibertadTarjetas({ mesLibreDeudas, tieneDeuda }: LibertadTarjetasProps) {
  return (
    <div className="bg-gradient-to-r from-emerald-950/50 to-zinc-900 border border-emerald-500/30 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
