    ...
    <div className="space-y-6">
      <div className="flex gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-3 bg-transparent border border-zinc-700 rounded-xl text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors text-sm font-medium"
        >
                ...
                <div className="space-y-2">
                  {items.map((t) => {
                    ...
                    return (
                      <div
                        key={t.id}
                        className="flex items-center gap-4 p-4 bg-zinc-900/60 border border-zinc-800/60 rounded-xl hover:border-zinc-700/80 transition-colors"
                      >
                        <div
                        ...
                        <span
                          className={`font-mono font-semibold text-lg shrink-0 ${
